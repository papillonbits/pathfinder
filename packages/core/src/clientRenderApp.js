...
import { appRootRoute, listGnomePageRoute, infoGnomePageRoute, notFoundPageRoute } from './route'
      ...
      <Provider store={clientAppStore}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path={listGnomePageRoute.path} element={listGnomePageRoute.clientComponent()} />
            <Route path={infoGnomePageRoute.path} element={infoGnomePageRoute.clientComponent()} />
